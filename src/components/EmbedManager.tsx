...
function getImageUrl(
  manifest: NonNullable<typeof manifestCache>,
  type: "formation" | "coverage",
  id: string,
): string | undefined {
  const imageFilename =
    type === "formation"
...
/**
 * Manages Open Graph / Twitter / Discord meta tags.
 * Always sets a dark theme-color so embeds render with a dark accent.
 */
    ...
    const updateTags = async () => {
      ...
      if (path === "/") {
        metadata = {
          ...
          description:
            "A comprehensive glossary of football formations, coverages, and terminology.",
          url: fullUrl,
        };
        ...
        if (formation) {
          metadata = {
            ...
            description: getFormationDescription(
              formation.name,
              formation.category,
        ...
        if (coverage) {
          metadata = {
            ...
            description: getCoverageDescription(
              coverage.name,
